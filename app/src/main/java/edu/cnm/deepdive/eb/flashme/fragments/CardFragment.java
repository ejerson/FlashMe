...
public class CardFragment extends Fragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (getArguments().containsKey(ARG_ITEM_ID)) {
      ...
      try {
        mItem = ((CardFragmentDaoInteraction) getContext())
            .getCardDao().queryForId(getArguments().getInt(ARG_ITEM_ID));
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    if (mItem != null) {
      ((TextView) rootView.findViewById(R.id.card_detail)).setText(mItem.toString());
  ...
  public interface CardFragmentDaoInteraction {
    Dao<Card, Integer> getCardDao() throws SQLException;
  }
}
